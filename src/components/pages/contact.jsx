    ...
    return(
     <div class="relative bg-white px-10">
        <div class="lg:absolute lg:inset-0 lg:left-1/2  ">
             <img class="rounded-full h-64 w-full bg-white object-cover sm:h-80 lg:absolute lg:h-full rounded-md border border-2" src={Logo}/>
        </div>
  <div class="px-10">
      ...
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        ...
        <form action="#"  class=" shadow-full">
          <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
            ...
            <button type="submit" class="rounded-md bg-blue-400 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send message</button>
          </div>
        </form>
        </div>
    </div>
