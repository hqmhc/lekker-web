    ...
    <>
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
          <img
            ...
            src="https://www.freshbooks.com/wp-content/uploads/2021/09/online-invoicing-portal.jpg"      alt=""
          />
        </div>
        <div className="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6  bg-gray-100 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            <div className="mt-8">
              <div>
                <div>
                  <p className="text-sm font-medium leading-6 text-blue-400">Sign in with</p>
                  ...
                  <div className="mt-2 grid grid-cols-3 gap-3">
                    <div>
                      ...
                      >
                        <span className="sr-only text-blue-400">Sign in with Facebook</span>
                    ...
                    <div>
                      <a
                        ...
                        className="inline-flex w-full justify-center rounded-md bg-white py-2 px-3 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0"
                      >
                        <span className="sr-only text-blue-400 ">Sign in with Twitter</span>
                        <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="relative mt-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="bg-white px-2  text-blue-400 ">Or continue with</span>
                  </div>
                </div>
              </div>
